  ...
  return (
    <div className="bg-grey-light">
      ...
      <main className="min-h-screen p-4 md:p-6 md:pt-0 md:flex gap-6">
        <div className="w-[560px] bg-white hidden md:flex items-center justify-center rounded-xl shrink-0">
          <div className="relative mx-auto border-[rgb(31,_41,_55)] bg-[rgb(31,_41,_55)] border-[14px] rounded-[2.5rem] h-[600px] w-[300px] shadow-xl">
            ...
            <div className="rounded-[2rem] overflow-hidden w-[272px] h-[572px] bg-white">
              <div className="flex flex-col justify-center items-center h-full gap-14">
                ...
                <div className="flex flex-col justify-center items-center gap-5 w-[237px]">
                  {!data
